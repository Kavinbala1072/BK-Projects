...
Public Class Install
    Private Const AppUrl As String = "https://github.com/Kavinbala1072/Attma/archive/refs/heads/main.zip"
    Private Const AppName As String = "latest"
            ...
            If File.Exists(configPath) Then
                ...
                For i As Integer = 0 To lines.Count - 1
                    If lines(i).Trim().StartsWith("CurrentVersion=") Then
                        lines(i) = "CurrentVersion=" & Form1.Version
                        isFound = True
                        Exit For
                    End If
                Next
                If Not isFound Then lines.Add("CurrentVersion=" & Form1.Version)
