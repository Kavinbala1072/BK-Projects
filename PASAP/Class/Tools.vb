...
Public Class Tools
    ...
    Private Shared Function GetGetRequestStream(req As HttpWebRequest) As Stream
    ...
    Public Shared Function GetCompanyDetails() As DataTable
        ...
        Try
            ...
            End Using
        Catch ex As Exception
            ' Handle error or return empty table
        End Try
        Return dt
    End Function
End Class
