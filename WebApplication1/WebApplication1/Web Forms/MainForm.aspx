...
<head runat="server">
    ...
    <style>
        ...
        @media (min-width: 769px) {
            ...
            /* UPDATED: Added .menu-header to display:none when sidebar is active */
            #sidebar.active .sidebar-header h3, 
            #sidebar.active .nav-btn span,
            #sidebar.active .menu-header { display: none; }
        ...
        <div id="wrapper">
            <nav id="sidebar">
                <div class="sidebar-header">
                    <h3 class="fw-bold text-white">BK Reporting</h3>
                ...
                <div class="flex-grow-1 mt-2 overflow-auto">
                    <ul class="list-unstyled">
                        <li>
                            <asp:LinkButton ID="btnMenuDash" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuDash_Click">
                                <i class="fas fa-layer-group"></i> <span>Dashboard</span>
                            </asp:LinkButton>
                        </li>

                        <li class="menu-header">Daily Reports</li>
                        <li>
                            <asp:LinkButton ID="btnMenuLedger" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuLedger_Click">
                                <i class="fas fa-book-open"></i> <span>Ledger Reports</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnMenuStock" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuStock_Click">
                                <i class="fas fa-boxes-stacked"></i> <span>Stock Summary</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnMenuSales" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuSales_Click">
                                <i class="fas fa-cart-shopping"></i> <span>Sales Report</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnMenuPurchase" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuPurchase_Click">
                                <i class="fas fa-truck-ramp-box"></i> <span>Purchase Report</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnMenuPayable" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuOutstandingPayable_Click">
                                <i class="fas fa-file-invoice-dollar"></i> <span>Outstanding</span>
                            </asp:LinkButton>
                        </li>

                        <li class="menu-header">Data Inquiry</li>
                        <li>
                            <asp:LinkButton ID="btnItem" runat="server" CssClass="nav-btn menu-link" OnClick="btnItem_Click">
                                <i class="fas fa-magnifying-glass"></i> <span>Item Details</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnLedger" runat="server" CssClass="nav-btn menu-link" OnClick="btnLedger_Click">
                                <i class="fas fa-address-book"></i> <span>Ledger Details</span>
                            </asp:LinkButton>
                        </li>

                        <li class="menu-header">Final Accounts</li>
                        <li>
                            <asp:LinkButton ID="btnMenuTrialBalance" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuTrialBalance_Click">
                                <i class="fas fa-scale-balanced"></i> <span>Trial Balance</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnMenuProfitLoss" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuProfitLoss_Click">
                                <i class="fas fa-chart-line"></i> <span>Profit & Loss</span>
                            </asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton ID="btnMenuBalanceSheet" runat="server" CssClass="nav-btn menu-link" OnClick="btnMenuBalanceSheet_Click">
                                <i class="fas fa-file-contract"></i> <span>Balance Sheet</span>
                            </asp:LinkButton>
                        </li>
                    </ul>
                </div>
