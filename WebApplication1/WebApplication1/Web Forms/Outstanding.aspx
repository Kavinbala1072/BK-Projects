...
<head runat="server">
    ...
    <style>
        ...
        /* Column Control */
        .col-ledger { width: auto; font-weight: 500; color: var(--primary-dark1); }
        ...
        .btn-custom { 
            ...
            border: 1px solid var(--border-color);
            background: white; color: var(--primary-dark1);
            ...
            <div class="footer-toolbar">
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <div class="d-flex align-items-center">
                        <span class="date-label">AS ON DATE:</span>
                ...
                <div class="right-buttons">
                    <asp:LinkButton ID="btnExit" runat="server" CssClass="btn-custom border-danger" OnClick="btnExit_Click">
                        <i class="fas fa-sign-out-alt text-danger"></i> <span class="text-danger">Exit</span>
                    </asp:LinkButton>
                </div>
            </div>
