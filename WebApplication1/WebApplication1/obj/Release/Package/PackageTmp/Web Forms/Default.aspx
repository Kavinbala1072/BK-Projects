...
<html>
<head runat="server">
    <title>Reporting Portal - Secure Access</title>
        ...
        <div class="main-wrapper">
            <div class="config-card">
                <div class="card-header">
                    ...
                    <h4 class="mb-1 fw-bold">Reporting Portal</h4>
                ...
                <div class="card-body p-4 p-sm-5">
                    ...
                    <asp:Panel ID="pnlLogin" runat="server">
                        ...
                        <asp:Button ID="btnLogin" runat="server" Text="Authenticate" OnClick="btnLogin_Click" CssClass="btn-action" />
                    </asp:Panel>
                ...
                <div class="card-footer bg-light border-0 py-3 text-center">
                    <span class="text-muted extra-small" style="font-size: 0.7rem;">&copy; <%: DateTime.Now.Year %> BK Group</span>
                </div>
            </div>
        </div>
    </form>
