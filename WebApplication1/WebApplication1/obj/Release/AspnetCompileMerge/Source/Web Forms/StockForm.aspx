...
<head runat="server">
    ...
    <style>
        ...
        .report-table { 
            ...
            font-size: 13px; min-width: 1000px; /* Force minimum width to prevent squishing */
        }
        ...
        .btn-custom:hover { background: #f1f5f9; border-color: #cbd5e1; color: var(--primary); }
        .btn-refresh { background-color: var(--primary) !important; color: #fff !important; border: none; }
        .btn-refresh:hover { background-color: var(--primary-dark) !important; }

        .date-input { width: 160px; height: 38px; border-radius: 6px; border: 1px solid var(--border-color); font-size: 13px; padding: 5px; }

        /* MODAL STYLING */
        .modal-header { background: var(--header-dark); color: white; padding: 1rem 1.5rem; }
        .modal-content { border-radius: 12px; border: none; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1); }
        .filter-label { font-weight: 700; font-size: 11px; color: #64748b; text-transform: uppercase; margin-bottom: 5px; display: block; }
        .form-select-sm { height: 38px; border-radius: 6px; border-color: var(--border-color); }

        /* COLUMN WIDTHS */
        .col-sno { width: 50px; text-align: center; }
        .col-qty, .col-pcs, .col-rate, .col-mrp { text-align: right; width: 100px; }
        .col-name { width: 250px; font-weight: 500; }

        /* RESPONSIVE */
        @media (max-width: 992px) {
            .footer-toolbar { flex-direction: column; height: auto; gap: 15px; padding: 15px; }
            .d-flex.align-items-center { width: 100%; justify-content: center; flex-wrap: wrap; }
            .date-input { width: 100%; margin-bottom: 5px; }
            .btn-custom { width: 100%; justify-content: center; margin-bottom: 5px; }
            ...
            <div class="footer-toolbar">
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <div class="d-flex align-items-center">
                        <span class="text-muted small fw-bold text-uppercase me-2">As On:</span>
