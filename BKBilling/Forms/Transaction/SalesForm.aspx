<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesForm.aspx.cs" Inherits="BKBilling.Forms.Transaction.SalesForm" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sales Invoice | BK Softwares</title>
    ...
    <style>
        ...
        .section-title { font-size: 0.8rem; font-weight: 700; color: #4f46e5; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 15px; }
        .form-label { font-weight: 600; font-size: 0.75rem; color: #475569; margin-bottom: 2px; }
        .table-items thead { background: #4f46e5; color: white; font-size: 0.75rem; }
        .total-box { background: #f0f7ff; border-radius: 8px; padding: 15px; border: 1px solid #e0e7ff; }
        .grand-total { font-size: 1.5rem; font-weight: 800; color: #4f46e5; }
            ...
            <asp:Panel ID="pnlList" runat="server">
                <div class="card-custom p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fw-bold m-0 text-dark"><i class="fas fa-file-invoice-dollar me-2 text-primary"></i>Sales Register</h4>
                        <asp:LinkButton ID="btnOpenCreate" runat="server" CssClass="btn btn-primary px-4 fw-bold shadow-sm" OnClick="btnOpenCreate_Click">
                            <i class="fas fa-plus me-1"></i> New Sales Invoice
                        </asp:LinkButton>
                    </div>
                    <asp:GridView ID="gvSales" runat="server" AutoGenerateColumns="false" CssClass="table table-hover align-middle" 
                        GridLines="None" DataKeyNames="Sales_Sno" OnRowCommand="gvSales_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="Invoice_No" HeaderText="Inv #" />
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandName="EditRecord" CommandArgument='<%# Eval("Sales_Sno") %>' CssClass="btn btn-sm btn-outline-secondary"><i class="fas fa-edit"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
            ...
            <asp:Panel ID="pnlForm" runat="server" Visible="false">
                <div class="card-custom p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                        ...
                        <h4 class="fw-bold m-0">Sales Invoice</h4>
                        <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-success px-5 fw-bold shadow-sm" OnClick="btnSave_Click"><i class="fas fa-save me-2"></i>SAVE INVOICE</asp:LinkButton>
                    </div>

                    <div class="row g-3 mb-4">
                        <div class="col-md-2">
                            <label class="form-label">Invoice No</label>
                            <asp:TextBox ID="txtInvNo" runat="server" CssClass="form-control form-control-sm" placeholder="Auto"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            <label class="form-label text-muted">Customer Billing Detail</label>
                            <div class="info-box"><asp:Literal ID="litCustomerDetail" runat="server" Text="Select customer..."></asp:Literal></div>
                        </div>
                    </div>

                    <p class="section-title">Invoice Item Details</p>
                    <asp:UpdatePanel ID="upItems" runat="server">
                        <ContentTemplate>
                            <div class="table-responsive mb-3">
                                ...
                                <asp:LinkButton ID="btnAddRow" runat="server" CssClass="btn btn-sm btn-outline-primary fw-bold" OnClick="btnAddRow_Click"><i class="fas fa-plus me-1"></i> Add Row</asp:LinkButton>
                            </div>

                            <div class="row">
                                <div class="col-md-7">
                                    <label class="form-label">Narration</label>
                                    <asp:TextBox ID="txtNotes" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="4"></asp:TextBox>
                                </div>
                                <div class="col-md-5">
                                    <div class="total-box">
                                        <div class="d-flex justify-content-between mb-2"><span>Sub Total</span><asp:Label ID="lblSubTotal" runat="server" Text="0.00" CssClass="fw-bold"></asp:Label></div>
                                        <div class="d-flex justify-content-between mb-2"><span>Freight</span><asp:TextBox ID="txtFreight" runat="server" CssClass="form-control form-control-sm w-50 text-end" Text="0" AutoPostBack="true" OnTextChanged="RecalculateRow"></asp:TextBox></div>
                                        ...
                                        <div class="d-flex justify-content-between mb-2 text-primary fw-bold border-top pt-2"><span>GST Total</span><asp:Label ID="lblTaxTotal" runat="server" Text="0.00"></asp:Label></div>
