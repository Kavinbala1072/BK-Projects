<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderForm.aspx.cs" Inherits="BKBilling.Forms.Transaction.PurchaseOrderForm" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Purchase Order | BK Softwares</title>
    ...
    <style>
        ...
        .section-title { font-size: 0.8rem; font-weight: 700; color: #d97706; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 15px; }
        .form-label { font-weight: 600; font-size: 0.75rem; color: #475569; margin-bottom: 2px; }
        .table-items thead { background: #d97706; color: white; font-size: 0.75rem; }
        .total-box { background: #fffbeb; border-radius: 8px; padding: 15px; border: 1px solid #fef3c7; }
        .grand-total { font-size: 1.5rem; font-weight: 800; color: #b45309; }
            ...
            <asp:Panel ID="pnlList" runat="server">
                <div class="card-custom p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fw-bold m-0 text-dark"><i class="fas fa-file-signature me-2 text-warning"></i>Purchase Order Register</h4>
                    ...
                    <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="false" CssClass="table table-hover align-middle gv-style" 
                        GridLines="None" DataKeyNames="PO_Sno" OnRowCommand="gvOrders_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="PO_No" HeaderText="PO #" />
                            <asp:BoundField DataField="PO_Date" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="Supplier_Name" HeaderText="Supplier" />
                            <asp:BoundField DataField="Expected_Delivery" HeaderText="Expected Delivery" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="Grand_Total" HeaderText="Total Amount" DataFormatString="{0:N2}" />
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandName="EditRecord" CommandArgument='<%# Eval("PO_Sno") %>' CssClass="btn btn-sm btn-outline-secondary"><i class="fas fa-edit"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
            ...
            <asp:Panel ID="pnlForm" runat="server" Visible="false">
                <div class="card-custom p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                        ...
                        <h4 class="fw-bold m-0">Create Purchase Order</h4>
                        <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-warning px-5 fw-bold text-white shadow-sm" OnClick="btnSave_Click"><i class="fas fa-save me-2"></i>SAVE ORDER</asp:LinkButton>
                    </div>

                    <div class="row g-3 mb-4">
                        <div class="col-md-2">
                            <label class="form-label">PO Number</label>
                            <asp:TextBox ID="txtPONo" runat="server" CssClass="form-control form-control-sm" placeholder="Auto"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <label class="form-label text-primary">Expected Delivery</label>
                            <asp:TextBox ID="txtExpDate" runat="server" CssClass="form-control form-control-sm" TextMode="Date"></asp:TextBox>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="info-box small"><asp:Literal ID="litSupplierDetail" runat="server" Text="Select supplier..."></asp:Literal></div>
                        </div>
                    </div>

                    <p class="section-title">Items to Order</p>
                    <asp:UpdatePanel ID="upItems" runat="server">
                        <ContentTemplate>
                            <div class="table-responsive mb-3">
                                ...
                                <asp:LinkButton ID="btnAddRow" runat="server" CssClass="btn btn-sm btn-outline-warning fw-bold" OnClick="btnAddRow_Click"><i class="fas fa-plus me-1"></i> Add Row</asp:LinkButton>
                            </div>

                            <div class="row">
                                <div class="col-md-7">
                                    <label class="form-label">Notes for Supplier</label>
                                    <asp:TextBox ID="txtNotes" runat="server" CssClass="form-control form-control-sm" TextMode="MultiLine" Rows="4" placeholder="Payment terms, special instructions..."></asp:TextBox>
                                </div>
                                <div class="col-md-5">
                                    <div class="total-box shadow-sm">
                                        ...
                                        <div class="d-flex justify-content-between mb-2"><span>Estimated Freight</span><asp:TextBox ID="txtFreight" runat="server" CssClass="form-control form-control-sm w-50 text-end" Text="0" AutoPostBack="true" OnTextChanged="RecalculateRow"></asp:TextBox></div>
                                        <div class="d-flex justify-content-between mb-2 text-warning fw-bold border-top pt-2"><span>Estimated GST</span><asp:Label ID="lblTaxTotal" runat="server" Text="0.00"></asp:Label></div>
