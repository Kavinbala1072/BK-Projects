<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryMaster.aspx.cs" Inherits="BKBilling.Forms.Inventory.CategoryMaster" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Category Master | BK Softwares</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hfCategorySno" runat="server" />
            ...
            <asp:Panel ID="pnlList" runat="server">
                <div class="card-custom">
                    <div class="form-header d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bold m-0 text-dark">Category Directory</h3>
                            <p class="text-muted small m-0">Organize items into groups (e.g., T-Shirts, Sarees).</p>
                        </div>
                        <div class="d-flex gap-3">
                            <div class="input-group input-group-sm" style="width: 280px;">
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search categories..." AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" />
                    ...
                    <asp:GridView ID="gvCategories" runat="server" AutoGenerateColumns="false" CssClass="table gv-style" 
                        GridLines="None" DataKeyNames="ItemGroup_Sno" OnRowCommand="gvCategories_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="ItemGroup_Sno" HeaderText="ID" ItemStyle-Width="120px" ItemStyle-CssClass="text-muted font-monospace small" />
                            <asp:BoundField DataField="ItemGroup_Name" HeaderText="Category Name" ItemStyle-CssClass="fw-bold text-dark" />
                            <asp:BoundField DataField="ParentCategoryName" HeaderText="Under Group" />
                            ...
                            <asp:TemplateField HeaderText="Actions" ItemStyle-CssClass="text-end pe-4">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-sm btn-outline-primary fw-bold" 
                                        CommandName="EditRecord" CommandArgument='<%# Eval("ItemGroup_Sno") %>'>
            ...
            <asp:Panel ID="pnlForm" runat="server" Visible="false">
                <div class="card-custom">
                    ...
                    <div class="form-body">
                        <div class="row g-5">
                            <div class="col-md-7">
                                <p class="section-title">Identity & Hierarchy</p>
                                
                                <div class="mb-4">
                                    <label class="form-label">Category Name <span class="text-danger">*</span></label>
                                    <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control form-control-sm" placeholder="e.g. MEN'S WEAR"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txtCategoryName" ErrorMessage="Category name is required" CssClass="text-danger small mt-1 d-block" Display="Dynamic" ValidationGroup="save" />
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Under Category (Parent)</label>
                                    <asp:DropDownList ID="ddlParentCategory" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
                                    <div class="form-text small mt-2">Choose "PRIMARY" if this is a top-level category.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5 border-start ps-md-5">
                                ...
                                <div class="modern-switch form-check form-switch mb-4">
                                    ...
                                    <label for="<%= chkIsActive.ClientID %>">Is this category currently active?</label>
                                </div>
                                
                                <div class="p-3 bg-light rounded border-start border-4 border-primary small text-muted">
                                    <i class="fas fa-info-circle me-1"></i> <strong>Note:</strong> Deactivating a category will prevent users from selecting it in Item Master.
                                </div>
                            </div>
                        </div>
                    </div>
