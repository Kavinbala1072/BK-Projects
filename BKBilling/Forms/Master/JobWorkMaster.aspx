<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobWorkMaster.aspx.cs" Inherits="BKBilling.Forms.Master.JobWorkMaster" EnableEventValidation="false" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <title>Labour Management | Pro ERP</title>
            ...
            <ContentTemplate>
                <div class="erp-wrapper">
                    ...
                    <div class="erp-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                <h4 class="page-title"><i class="fas fa-person-digging text-primary me-2"></i><asp:Literal ID="litTitle" runat="server" /></h4>
                                
                                <asp:PlaceHolder ID="phSearchControls" runat="server">
                                    <div class="search-pill">
                                        <i class="fas fa-search"></i>
                                        <asp:TextBox ID="txtSearchAll" runat="server" CssClass="form-control" placeholder="Search labour..." AutoPostBack="true" OnTextChanged="GridFilter_Changed"></asp:TextBox>
                                    </div>
                                </asp:PlaceHolder>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <asp:PlaceHolder ID="phSearchButtons" runat="server">
                                    ...
                                    <asp:LinkButton ID="btnOpenCreate" runat="server" CssClass="btn-primary-erp" OnClick="btnOpenCreate_Click"><i class="fas fa-plus me-2"></i>New Labour</asp:LinkButton>
                                </asp:PlaceHolder>
                                <asp:PlaceHolder ID="phAddButtons" runat="server" Visible="false">
                                    ...
                                    <asp:LinkButton ID="btnSave" runat="server" CssClass="btn-primary-erp bg-success" OnClick="btnSave_Click"><i class="fas fa-save me-2"></i>SAVE WORKER</asp:LinkButton>
                                </asp:PlaceHolder>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="erp-body">
                        ...
                        <asp:Panel ID="pnlList" runat="server">
                            <div class="gv-container">
                                <asp:GridView ID="gvWorkers" runat="server" AutoGenerateColumns="false" CssClass="gv-pro"
                                    GridLines="None" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="gvWorkers_Sorting" OnRowCommand="gvWorkers_RowCommand"
                            ...
                            <div class="container-fluid p-4">
                                <div class="row g-4 justify-content-center">
                                    ...
                                    <div class="col-md-5 border-end">
                                        <p class="section-title"><i class="fas fa-user-tag"></i> 1. Labour Identity</p>
                                        <div class="mb-3">
                                            <label class="form-label">Full Name *</label>
                                            <asp:TextBox ID="txtWorkerName" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="row g-2 mb-3">
                                            <div class="col-6"><label class="form-label">Worker ID/Code *</label><asp:TextBox ID="txtWorkerCode" runat="server" CssClass="form-control"></asp:TextBox></div>
                                            <div class="col-6"><label class="form-label">Mobile Number *</label><asp:TextBox ID="txtPhone" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="modern-switch form-check form-switch mb-3">
                                            ...
                                            <label class="form-label mb-0 ms-2" for="<%= chkActive.ClientID %>">Labour Account is Active</label>
                                        </div>
                                    </div>

                                    <!-- COL 2: ADDRESS & FINANCIALS -->
                                    <div class="col-md-5">
                                        <p class="section-title"><i class="fas fa-map-location-dot"></i> 2. Contact & Financials</p>
                                        <div class="mb-3">
                                            <label class="form-label">Residential Address</label>
                                            <asp:TextBox ID="txtAdd1" runat="server" CssClass="form-control mb-2" placeholder="Local / Street Address"></asp:TextBox>
                                            <asp:TextBox ID="txtAdd2" runat="server" CssClass="form-control" placeholder="City / Hometown"></asp:TextBox>
                                        </div>
                                        <div class="row g-2 mb-3">
                                            ...
                                            <div class="col-5"><label class="form-label">Email (Optional)</label><asp:TextBox ID="txtEmail" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                        <div>
                                            <label class="form-label">Specialization / Remarks</label>
                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3" placeholder="e.g. Tailoring, Embroidery, Master..."></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <asp:Panel ID="pnlFooter" runat="server" CssClass="erp-footer">
                        <div class="small text-muted">Showing <b><asp:Literal ID="litVisibleCount" runat="server" Text="0" /></b> of <b><asp:Literal ID="litTotalCount" runat="server" Text="0" /></b> recorded personnel</div>
