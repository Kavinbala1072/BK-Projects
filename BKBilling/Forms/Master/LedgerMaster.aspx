<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LedgerMaster.aspx.cs" Inherits="BKBilling.Forms.Master.LedgerMaster" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <style>
        ...
        .gv-pro { width: 100%; border-collapse: separate; border-spacing: 0; min-width: 1300px; }
        .gv-pro th { 
                    ...
                    <div class="erp-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                <h4 class="page-title"><i class="fas fa-address-book text-primary me-2"></i><asp:Literal ID="litTitle" runat="server" /></h4>
                                
                                <asp:PlaceHolder ID="phSearchControls" runat="server">
                                    <div class="search-pill">
                                        <i class="fas fa-search"></i>
                                        <asp:TextBox ID="txtSearchAll" runat="server" CssClass="form-control" placeholder="Global Ledger Search..." AutoPostBack="true" OnTextChanged="GridFilter_Changed"></asp:TextBox>
                                    </div>
                                </asp:PlaceHolder>
                            </div>
                            ...
                            <div class="gv-container">
                                <asp:GridView ID="gvLedgers" runat="server" AutoGenerateColumns="false" CssClass="gv-pro"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LedgerGroup_Name" HeaderText="Under Group" />
                                        <asp:BoundField DataField="Ledger_Phone" HeaderText="Mobile" />
                                        <asp:BoundField DataField="ledger_bank" HeaderText="Bank" />
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4 border-end">
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-6"><label class="form-label">Ledger Code</label><asp:TextBox ID="txtLedgerCode" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-6"><label class="form-label">Account Group</label><asp:DropDownList ID="ddlGroup" runat="server" CssClass="form-select"></asp:DropDownList></div>
                                        ...
                                        <div class="row g-2 mb-3">
                                            ...
                                            <div class="col-6"><label class="form-label">Limit Days</label><asp:TextBox ID="txtCreditDays" runat="server" CssClass="form-control" Text="0"></asp:TextBox></div>
                                        </div>
                                        <div class="modern-switch form-check form-switch mb-3">
                                            <input type="checkbox" id="chkTDS" runat="server" class="form-check-input" />
                                            <label class="form-label mb-0 ms-2" for="<%= chkTDS.ClientID %>">TDS/TCS Applicable?</label>
                                        </div>
                                    ...
                                    <div class="col-md-4 border-end">
                                        ...
                                        <div class="modern-switch form-check form-switch mb-3">
                                            <input type="checkbox" id="chkUseGST" runat="server" class="form-check-input" checked="checked" />
                                            <label class="form-label mb-0 ms-2" for="<%= chkUseGST.ClientID %>">Enable GST Compliance</label>
                                        </div>
                                        ...
                                        <div class="mb-2">
                                            <label class="form-label">Banking Info</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3">
                                            <asp:TextBox ID="txtAdd1" runat="server" CssClass="form-control mb-1" placeholder="Building/Plot No"></asp:TextBox>
                                            <asp:TextBox ID="txtAdd2" runat="server" CssClass="form-control mb-1" placeholder="Street/Locality"></asp:TextBox>
