<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LedgerMaster.aspx.cs" Inherits="BKBilling.Forms.Master.LedgerMaster" %>
        ...
        <div class="container-fluid">
            ...
            <asp:Panel ID="pnlList" runat="server">
                <div class="card-custom p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-3">
                            <div class="input-group input-group-sm" style="width: 300px;">
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by name or code..." AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" />
                    ...
                    <asp:GridView ID="gvLedgers" runat="server" AutoGenerateColumns="false" CssClass="table gv-style" 
                        GridLines="None" DataKeyNames="Ledger_Sno" OnRowCommand="gvLedgers_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="ledger_code" HeaderText="Code" />
                            <asp:BoundField DataField="ledger_name" HeaderText="Ledger Name" ItemStyle-CssClass="fw-bold" />
                            <asp:BoundField DataField="ledger_bank" HeaderText="Bank" />
                            <asp:BoundField DataField="Ledger_Phone" HeaderText="Phone" />
                            ...
                            <asp:TemplateField HeaderText="Actions" ItemStyle-CssClass="text-end">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-sm btn-outline-primary" 
                                        CommandName="EditRecord" CommandArgument='<%# Eval("Ledger_Sno") %>'><i class="fas fa-edit me-1"></i>Edit</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
