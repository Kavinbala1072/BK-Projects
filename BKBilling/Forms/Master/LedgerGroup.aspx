<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LedgerGroup.aspx.cs" Inherits="BKBilling.Forms.Master.LedgerGroup" EnableEventValidation="false" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <title>Account Groups | Pro ERP</title>
    ...
    <style>
        ...
        /* Badges */
        .badge-pill { font-size: 0.65rem; padding: 4px 10px; border-radius: 50px; font-weight: 800; text-transform: uppercase; }
        ...
        .modern-switch { display: flex; align-items: center; background: #f8fafc; padding: 12px 20px; border-radius: 10px; border: 1px solid var(--erp-border); width: fit-content; cursor: pointer; }
            ...
            <ContentTemplate>
                <div class="erp-wrapper">
                    ...
                    <div class="erp-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                <h4 class="page-title"><i class="fas fa-folder-tree text-primary me-2"></i><asp:Literal ID="litTitle" runat="server" /></h4>
                                
                                <asp:PlaceHolder ID="phSearchControls" runat="server">
                                    <div class="search-pill">
                                        <i class="fas fa-search"></i>
                                        <asp:TextBox ID="txtSearchAll" runat="server" CssClass="form-control" placeholder="Search groups..." AutoPostBack="true" OnTextChanged="GridFilter_Changed"></asp:TextBox>
                                    </div>
                                </asp:PlaceHolder>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <asp:PlaceHolder ID="phSearchButtons" runat="server">
                                    ...
                                    <asp:LinkButton ID="btnOpenCreate" runat="server" CssClass="btn-primary-erp" OnClick="btnOpenCreate_Click"><i class="fas fa-plus me-2"></i>New Group</asp:LinkButton>
                                </asp:PlaceHolder>
                                <asp:PlaceHolder ID="phAddButtons" runat="server" Visible="false">
                                    ...
                                    <asp:LinkButton ID="btnSave" runat="server" CssClass="btn-primary-erp bg-success" OnClick="btnSave_Click"><i class="fas fa-save me-2"></i>SAVE GROUP</asp:LinkButton>
                                </asp:PlaceHolder>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="erp-body">
                        ...
                        <asp:Panel ID="pnlList" runat="server">
                            <div class="gv-container">
                                <asp:GridView ID="gvGroups" runat="server" AutoGenerateColumns="false" CssClass="gv-pro"
                                    GridLines="None" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="gvGroups_Sorting" OnRowCommand="gvGroups_RowCommand"
                                    AllowPaging="true" PagerSettings-Visible="false">
                                    <Columns>
                                        <asp:TemplateField HeaderText="ID" HeaderStyle-Width="100px" SortExpression="LedgerGroup_Sno">
                                            <ItemTemplate><%# Eval("LedgerGroup_Sno") %></ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField SortExpression="LedgerGroup_Name">
                                            ...
                                            <ItemTemplate><b><%# Eval("LedgerGroup_Name") %></b></ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:BoundField DataField="ParentName" HeaderText="UNDER GROUP" SortExpression="ParentName" />
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-CssClass="text-center" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnView" runat="server" CommandName="ViewRecord" CommandArgument='<%# Eval("LedgerGroup_Sno") %>' CssClass="btn-tool border-0 text-info">
                                                    <i class="far fa-eye"></i>
                                                </asp:LinkButton>
                                                <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditGroup" CommandArgument='<%# Eval("LedgerGroup_Sno") %>' CssClass="btn-tool border-0 text-primary">
                            ...
                            <div class="container-fluid p-4">
                                <div class="row g-4">
                                    <div class="col-md-7 border-end">
                                        <p class="section-title"><i class="fas fa-info-circle"></i> Identity & Classification</p>
                                        <div class="mb-4">
                                            <label class="form-label">Group Name *</label>
                                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="form-control" placeholder="e.g. INDIRECT EXPENSES"></asp:TextBox>
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label class="form-label">Under Group (Parent)</label>
                                                <asp:DropDownList ID="ddlParentGroup" runat="server" CssClass="form-select" AutoPostBack="true" OnSelectedIndexChanged="ddlParentGroup_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-5">
                                        <p class="section-title"><i class="fas fa-toggle-on"></i> Configuration</p>
                                        <div class="modern-switch form-check form-switch mb-4">
                                            <input type="checkbox" id="chkIsActive" runat="server" class="form-check-input" checked="checked" />
                                            <label class="form-check-label mb-0 ms-2" for="<%= chkIsActive.ClientID %>">This group is currently active</label>
                                        </div>
                                        <div class="p-3 bg-light rounded border-start border-4 border-primary small text-muted">
                                            <i class="fas fa-circle-info me-1 text-primary"></i> <strong>Note:</strong> Nature is usually inherited from the Parent Group. Deactivating a group hides it from Ledger creation screens.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <asp:Panel ID="pnlFooter" runat="server" CssClass="erp-footer">
                        <div class="small text-muted">Showing <b><asp:Literal ID="litVisibleCount" runat="server" Text="0" /></b> of <b><asp:Literal ID="litTotalCount" runat="server" Text="0" /></b> recorded groups</div>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <asp:DropDownList ID="ddlPageSize" runat="server" CssClass="form-select form-select-sm ms-2" Width="100px" AutoPostBack="true" OnSelectedIndexChanged="GridFilter_Changed">
                                <asp:ListItem Text="20 Rows" Value="20" />
