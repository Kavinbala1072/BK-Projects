<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMaster.aspx.cs" Inherits="BKBilling.Forms.Master.CustomerMaster" EnableEventValidation="false" %>

<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <title>Customer Master | Pro ERP</title>
                    ...
                    <div class="erp-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                <h4 class="page-title"><i class="fas fa-user-tie text-primary me-2"></i><asp:Literal ID="litTitle" runat="server" /></h4>
                                
                                <asp:PlaceHolder ID="phSearchControls" runat="server">
                                    <div class="search-pill">
                                        <i class="fas fa-search"></i>
                                        <asp:TextBox ID="txtSearchAll" runat="server" CssClass="form-control" placeholder="Search Customer..." AutoPostBack="true" OnTextChanged="GridFilter_Changed"></asp:TextBox>
                                    </div>
                                </asp:PlaceHolder>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <asp:PlaceHolder ID="phSearchButtons" runat="server">
                                    ...
                                    <asp:LinkButton ID="btnOpenCreate" runat="server" CssClass="btn-primary-erp" OnClick="btnOpenCreate_Click"><i class="fas fa-plus me-2"></i>New Customer</asp:LinkButton>
                                </asp:PlaceHolder>
                                <asp:PlaceHolder ID="phAddButtons" runat="server" Visible="false">
                                    ...
                                    <asp:LinkButton ID="btnSave" runat="server" CssClass="btn-primary-erp bg-success" OnClick="btnSave_Click"><i class="fas fa-save me-2"></i>SAVE CUSTOMER</asp:LinkButton>
                                </asp:PlaceHolder>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="erp-body">
                        ...
                        <asp:Panel ID="pnlList" runat="server">
                            <div class="gv-container">
                                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" CssClass="gv-pro"
                                    GridLines="None" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="gvCustomers_Sorting" OnRowCommand="gvCustomers_RowCommand"
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4 border-end">
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-6"><label class="form-label">Customer Code *</label><asp:TextBox ID="txtCustCode" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        ...
                                        <div class="modern-switch form-check form-switch mb-3">
                                            ...
                                            <label class="form-label mb-0" for="<%= chkActive.ClientID %>">Account is Active</label>
                                        </div>
                                    </div>
