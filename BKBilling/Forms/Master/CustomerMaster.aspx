<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMaster.aspx.cs" Inherits="BKBilling.Forms.Master.CustomerMaster" %>
            ...
            <asp:Panel ID="pnlList" runat="server">
                <div class="card-custom p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h4 class="fw-bold m-0 text-dark"><i class="fas fa-users me-2 text-primary"></i>Customer Directory</h4>
                            <p class="text-muted small m-0">Group: Sundry Debtors (1000000032)</p>
                        </div>
                    ...
                    <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" CssClass="table gv-style" 
                        ...
                        <EmptyDataTemplate><div class="p-5 text-center text-muted">No customers found.</div></EmptyDataTemplate>
                    </asp:GridView>
                </div>
            </asp:Panel>
